...
class SoferAI:
    ...
    def __init__(
        ...
        *,
        ...
        api_key: str | typing.Callable[[], str] | None = os.getenv("SOFERAI_API_KEY"),
    ...
    def __init__(
        ...
        *,
        ...
        self._client_wrapper = AsyncClientWrapper(
            ...
            httpx_client=httpx_client
            if httpx_client is not None
            else httpx.AsyncClient(timeout=defaulted_timeout, follow_redirects=follow_redirects)
            if follow_redirects is not None
            else httpx.AsyncClient(timeout=defaulted_timeout),
            timeout=defaulted_timeout,
        )
...
def _get_base_url(*, base_url: str | None = None, environment: SoferAIEnvironment) -> str:
