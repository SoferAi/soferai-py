...
class SoferAiApi:
    ...
    environment : SoferAiApiEnvironment
        The environment to use for requests from the client. from .environment import SoferAiApiEnvironment



        Defaults to SoferAiApiEnvironment.PRODUCTION
    ...
    def __init__(
        ...
        *,
        ...
        environment: SoferAiApiEnvironment = SoferAiApiEnvironment.PRODUCTION,
        api_key: typing.Optional[
            typing.Union[str, typing.Callable[[], str]]
        ] = os.getenv("SOFERAI_API_KEY"),
...
def _get_base_url(
    *, base_url: typing.Optional[str] = None, environment: SoferAiApiEnvironment
) -> str:
