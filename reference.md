...
<details><summary><code>client.maishiv.<a href="src/soferai/maishiv/client.py">search_knowledge_base_chunks</a>(...)</code></summary>
<dl>
<dd>
...
**query:** `str` — Search query, trimmed before use; must contain 1 to 8000 characters after trimming.
...
**n:** `typing.Optional[int]` — Maximum passages to return; an integer from 1 to 50. Defaults to 10 when omitted or null.
