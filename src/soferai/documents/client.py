...
class DocumentsClient:
    ...
    def get_document(
        ...
        """
        _response = self._raw_client.get_document(document_id, request_options=request_options)
        return _response.data
    ...
    def update_document(
        ...
        *,
        ...
        _response = self._raw_client.update_document(
            document_id, title=title, folder_id=folder_id, archived=archived, request_options=request_options
        )
        return _response.data
    ...
    def create_document_translation(
        ...
        **API price:** USD 0.25 per 1,000 billable words, deducted from your API balance.
        ...
        """
        _response = self._raw_client.create_document_translation(
            document_id,
    ...
    def get_document_translation(
        ...
        *,
        ...
        """
        _response = self._raw_client.get_document_translation(
            document_id, target_language, translation_style=translation_style, request_options=request_options
        )
        return _response.data
...
class AsyncDocumentsClient:
    ...
    async def create_document(
        ...
        *,
        ...
        async def main() -> None:
            await client.documents.create_document()
    ...
    async def get_document(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_document(document_id, request_options=request_options)
        return _response.data
    ...
    async def create_document_translation(
        ...
        **API price:** USD 0.25 per 1,000 billable words, deducted from your API balance.
        ...
        async def main() -> None:
            await client.documents.create_document_translation(
                document_id=uuid.UUID(
                    "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
                ),
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.create_document_translation(
            document_id,
            target_language=target_language,
            translation_style=translation_style,
            force=force,
    ...
    async def get_document_translation(
        ...
        *,
        ...
        async def main() -> None:
            await client.documents.get_document_translation(
                document_id=uuid.UUID(
                    "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
                ),
                target_language="auto",
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_document_translation(
            document_id, target_language, translation_style=translation_style, request_options=request_options
        )
        return _response.data
