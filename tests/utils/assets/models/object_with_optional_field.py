...
class ObjectWithOptionalFieldParams(typing_extensions.TypedDict):
    ...
    set_: typing_extensions.NotRequired[typing_extensions.Annotated[set[str], FieldMetadata(alias="set")]]
    map_: typing_extensions.NotRequired[typing_extensions.Annotated[dict[int, str], FieldMetadata(alias="map")]]
