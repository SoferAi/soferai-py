...
class TranscribeClient:
    ...
    def create_transcription(
        ...
        *,
        ...
        audio_url: str | None = OMIT,
        audio_id: str | None = OMIT,
    ...
    def get_transcription_status(
        self, transcription_id: uuid.UUID, *, request_options: RequestOptions | None = None
    ) -> TranscriptionInfo:
        """
        ...
        try:
            if 200 <= response.status_code < 300:
                return typing.cast(
                    list[TranscriptionId],
                    parse_obj_as(
                        type_=list[TranscriptionId],  # type: ignore
                        object_=response.json(),
                    ),
                )
            response_json = response.json()
