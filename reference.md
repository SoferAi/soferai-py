...
<details><summary><code>client.ocr.<a href="src/soferai/ocr/client.py">create_ocr_translation</a>(...)</code></summary>
<dl>
<dd>
...
**target_mode:** `typing.Optional[str]` — Translation target mode. Use "auto" to translate Hebrew pages to English and English pages to Hebrew.
...
**force:** `typing.Optional[bool]` — Regenerate translated pages even when cached pages are current.
...
<details><summary><code>client.ocr.<a href="src/soferai/ocr/client.py">get_ocr_translation</a>(...)</code></summary>
<dl>
<dd>
...
**target_mode:** `str` — Translation target mode (auto, en, or he).
