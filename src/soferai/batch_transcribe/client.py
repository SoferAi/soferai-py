...
class BatchTranscribeClient:
    ...
    def list_batch_file_batches(
        ...
        *,
        ...
        """
        _response = self._raw_client.list_batch_file_batches(
            batch_file_id, limit=limit, offset=offset, request_options=request_options
        )
        return _response.data
...
class AsyncBatchTranscribeClient:
    ...
    async def list_batch_file_batches(
        ...
        *,
        ...
        async def main() -> None:
            await client.batch_transcribe.list_batch_file_batches(
                batch_file_id=uuid.UUID(
                    "f1234567-89ab-cdef-0123-456789abcdef",
                ),
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.list_batch_file_batches(
            batch_file_id, limit=limit, offset=offset, request_options=request_options
        )
        return _response.data
